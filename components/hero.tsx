            ...
            <div className="flex items-center gap-2 mb-8 md:mb-0">
                <div className="flex gap-2 items-center">
                    <div className="flex items-center">
                        <p className="text-7xl sm:text-[80px] md:text-[100px] font-semibold tabular-nums text-zinc-900 dark:text-zinc-800/25 dark:hover:text-zinc-900 font-sans transition-colors duration-300 rounded-lg leading-none">{hours}</p>
                        <p className="text-7xl sm:text-[80px] md:text-[100px] font-semibold tabular-nums text-zinc-900 dark:text-zinc-800/25 dark:hover:text-zinc-900 font-sans transition-colors duration-300 rounded-lg leading-none">:</p>
                        <p className="text-7xl sm:text-[80px] md:text-[100px] font-semibold tabular-nums text-zinc-900 dark:text-zinc-800/25 dark:hover:text-zinc-900 font-sans transition-colors duration-300 rounded-lg leading-none">{minutes}</p>
                    </div>
