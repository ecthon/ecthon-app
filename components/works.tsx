    ...
    return (
        <section aria-labelledby="works-title" className="flex flex-col gap-8 md:gap-10 w-full mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-4">
                {/* Links */}
                <div className="flex w-full h-full aspect-square md:aspect-auto md:row-span-1">
                    <Link href="https://ecthon.me/links" target="_blank" rel="noopener noreferrer" className="flex w-full h-full">
                        <div className="group w-full flex border border-zinc-200 dark:border-zinc-800 items-center justify-center flex-1 h-full rounded-2xl font-medium cursor-pointer bg-white dark:bg-zinc-950 p-1">
                            <div className="relative w-full h-full rounded-[14px] overflow-hidden bg-zinc-50 dark:bg-zinc-900/20">
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-6 z-20 translate-y-4 opacity-0 transition-all duration-500 ease-out group-hover:translate-y-0 group-hover:opacity-100 flex pointer-events-none">
                                    <p className="text-lg font-bold text-white font-sans text-left">Links</p>
                                </div>
                            </div>
                        </div>
                    </Link>
                ...
                {/* Cartão de embarque */}
                <div className="flex w-full h-full aspect-square md:aspect-auto md:row-span-2">
                    <Link href="https://boarding-pass-seven.vercel.app/" target="_blank" rel="noopener noreferrer" className="flex w-full h-full">
                        <div className="group w-full flex border border-zinc-200 dark:border-zinc-800 items-center justify-center flex-1 h-full rounded-2xl font-medium cursor-pointer bg-white dark:bg-zinc-950 p-1">
                            <div className="relative w-full h-full rounded-[14px] overflow-hidden bg-zinc-50 dark:bg-zinc-900/20">
                                <div className="flex w-full h-full flex-col justify-end transition-transform duration-500 ease-out group-hover:scale-110">
                                    <Image
