  ...
  return (
    <section className="mx-auto flex max-w-[1216px] flex-col items-center py-8 max-sm:py-16 md:py-12 md:pb-8 lg:py-40 lg:pb-20 gap-6">
      ...
      <div className="flex gap-2">
        ...
        <Link href="https://www.linkedin.com/in/ecthon/" target="_blank" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2 gap-2">
          <LinkedInLogoIcon />
          Linkedin
        </Link>
      </div>
