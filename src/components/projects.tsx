...
export function Projects() {
  return (
    <div className="flex flex-col w-[1216px] h-[800px] mx-auto mt-[-150px]">
      <h2 className="text-5xl font-thin mb-12 text-gray-400"><span className="font-normal text-gray-900">Projetos </span>recentes</h2>  
