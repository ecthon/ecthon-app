...
export default function LinksPage() {
    return (
        <main className="flex flex-col w-full max-w-[600px] px-4 mx-auto justify-center space-y-12">
            ...
            <div className="flex flex-col items-center justify-center gap-8 -mt-50 z-10">
                <Image src="/ecthon.jpeg" alt="Ecthon" width={1000} height={1000} quality={80} className="w-16 h-16 border-2 border-white rounded-full" />
